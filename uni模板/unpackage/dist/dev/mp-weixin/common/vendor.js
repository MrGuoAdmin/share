...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"模板","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
module.exports = {
  ...
  bankRegular: bankRegular };

/***/ }),
/* 13 */
/*!************************************!*\
  !*** D:/web文件/模板/utils/request.js ***!
  \************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _index = _interopRequireDefault(__webpack_require__(/*! @/config/index.config */ 14));
var _encryption = _interopRequireDefault(__webpack_require__(/*! @/utils/encryption.js */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                          * 封装网络请求
                                                                                                                                                                          */module.exports = function (params) {var seqID = _encryption.default.randomNumber();
  var time = _encryption.default.generationTimestamp();
  var sign = _encryption.default.hexMD5(seqID + _encryption.default.hexMD5(time + _encryption.default.Md5()));
  var url = _index.default.baseUrl + params.url; // 线上环境中开启
...
/* 14 */
/*!******************************************!*\
  !*** D:/web文件/模板/config/index.config.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var CONFIG = {
  ...
  development: {
    ...
    baseUrl: 'https://admin.jindianxiang.com', // 后台接口请求地址
    hostUrl: '', // H5地址(前端运行地址)
...
/* 15 */
/*!***************************************!*\
  !*** D:/web文件/模板/utils/encryption.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
function Md5() {
  var apk = "W1ST8bOSBGaPjvE5fhKIe+Jin3lDian==";
  return hexMD5(apk);
}
...
function randomNumber() {
  var random = ("0000000" + 100000000 * Math.random()).match(/(\d{8})(\.|$)/)[1];
  return random;
}
...
function parameters() {
  ...
  var item = generationTimestamp();
  var sign = "";
  sign = hexMD5(hexMD5(number) + hexMD5(item) + Md5());
  return sign;
}
...
// 姓名手机号身份证遮掩
function coverContent(str, frontLen, endLen) {//frontLen前面保留几位,endLen后面剩几位
...
module.exports = {
  changeTime: changeTime, //日期格式转换时间戳
  changeDate: changeDate, //秒数转换为日期格式
  getAge: getAge, //根据出生日期判断年龄
  coverContent: coverContent, //姓名手机号身份证遮掩
  dateFormat: dateFormat //获取日期
};

/***/ }),
/* 17 */
/*!************************************!*\
  !*** D:/web文件/模板/common/public.js ***!
  \************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // 公有参数，全局声明
var imgUrl = "/static/img/"; //图片路径

// 时间
var time = parseInt(new Date().getTime() / 1000);var _default =

{
  time: time, //时间
  // 营业时间
  openList: ["00:00", "00:30", "01:00", "01:30", "02:00", "02:30", "03:00", "03:30", "04:00", "04:30", "05:00",
  ...
  // 关门时间
  closeList: ["00:30", "01:00", "01:30", "02:00", "02:30", "03:00", "03:30", "04:00", "04:30", "05:00",
  "05:30", "06:00", "06:30", "07:00", "07:30", "08:00", "08:30", "09:00", "09:30", "10:00", "10:30", "11:00",
  "11:30", "12:00", "12:30", "13:00", "13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00",
  "17:30", "18:00", "18:30", "19:00", "19:30", "20:00", "20:30", "21:00", "21:30", "22:00", "22:30", "23:00",
  "23:30", "24:00"] };exports.default = _default;
